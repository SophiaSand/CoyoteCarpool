...
public class EmailPasswordActivity extends Activity {
    ...
    // Sign up new users which takes in email address and password, validates them, and creates a new user.
    ...
    // Sign in existing users which takes their email address and password, validates them, and signs a user in with this method.
